...
5.  Download the RBioTools tar.gz from here: <https://github.com/arkansas-research-platform/RBioTools/blob/86bfb42d86adc8deffa5bc2d35015d7274fdb654/docs/RBiotools_0.5.3.tar.gz>
...
```{r install.basics, eval=FALSE, echo=FALSE, error=FALSE, warning=FALSE, message=FALSE}
