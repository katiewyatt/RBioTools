...
5.  Download the RBioTools tar.gz from here: <https://github.com/nsf-dart/RBioTools/blob/91a28f0bc261617280a63ef0dbd4b712cbfb0200/docs/RBiotools_0.5.3.tar.gz>

    -   Save this tar.gz file in the root of your Working Directory

6.  Download the `getting-started.R` script from here: <https://github.com/nsf-dart/RBioTools/blob/91a28f0bc261617280a63ef0dbd4b712cbfb0200/docs/getting-started.html>
...
7.  Check the version of R that is being used. These instructions were prepared using R version 4.1.2 (2021-11-01, "Bird Hippie"); older or newer versions may behave differently.
